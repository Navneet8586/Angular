...
export const items:pricing[]=[
    ...
    {type:'Mens Wear',itemName:'Full Jacket',price:'150 - 200'},
    ...
    {type:'Carpet',itemName:'Single Blanket(SL)',price:'200'},
    {type:'Carpet',itemName:'Double Blanket(SL)',price:'300'},
    ...
    {type:'Carpet',itemName:'Curtain',price:'150 per panel'},
    {type:'Carpet',itemName:'Curtain Tissue/Net',price:'180 per panel'},
    {type:'Carpet',itemName:'Curtain Doule Lining',price:'200 per panel'},
    {type:'Carpet',itemName:'Sofa',price:'200 per seat'},
